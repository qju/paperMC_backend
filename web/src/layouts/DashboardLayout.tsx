...
import { Terminal, Users as UsersIcon, Settings, LogOut, HardDrive, Menu, Globe, DownloadCloud, Shield, Clock, Puzzle, ClipboardList, AlertTriangle, Activity } from 'lucide-react';
    ...
    return (
      ...
      `}>
                ...
                <nav className="flex-1 p-4 space-y-2 mt-16 md:mt-0">
                    ...
                    <NavItem to="/profiler" icon={<Activity size={20} />} label="Profiler & Spark" onClick={() => setMobileMenuOpen(false)} />
                </nav>
